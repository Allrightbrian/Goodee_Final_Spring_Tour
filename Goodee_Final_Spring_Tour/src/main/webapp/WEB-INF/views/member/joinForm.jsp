...
<body>
	...
	아이디 : <input type="text" name="id" maxlength="20"><button type="button" onclick="duplicateCheckId()" >아이디 중복체크</button> <br>
	...
	<button type="button" onclick="location.href='https://kauth.kakao.com/oauth/authorize?client_id=71f95f0473e2f3e8ba2976e1e2f3ec86&redirect_uri=http://localhost:8096/final_spring_tour_imsy/kakaoJoin.do&response_type=code'">카카오 회원가입</button>
</body>
</html>
