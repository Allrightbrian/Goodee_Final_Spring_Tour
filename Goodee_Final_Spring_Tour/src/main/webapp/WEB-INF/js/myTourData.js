...
$(document).ready(function() {
	...
	$('#search').click(function() {
		...
		var subCode = $("#sub_category option").index($("#sub_category option:selected"))+1;
		...
		$.ajax({
			...
			success: function(data) {
				...
				for (list in data) {
					...
					cell1.innerHTML =data[list].title;
					...
					var iwContent = '<div style="padding:5px;">' + data[list].title + '</div>' + '<label for="order">'+ "순서: " +'</label>'
